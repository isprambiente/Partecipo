...
#      post admin_templates_url, params: { admin_template: { data: @admin_template.data, title: @admin_template.title } }
#    end
#
...
#    patch admin_template_url(@admin_template), params: { admin_template: { data: @admin_template.data, title: @admin_template.title } }
